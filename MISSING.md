...
Note that this file updates only during Resonite build process and doesn't necessarily reflect the current state.
...
Notifications.ReceivedPoints  
Notifications.TransferedPoints  
